...
import { Game, Settlement } from "@/types";
...
interface GameSettlementProps {
  game: Game;
  initialFinalStacks: Record<string, number> | null;
  onCompleteSettlement: (settlement: Settlement) => void;
  onCancel: () => void;
}

export function GameSettlement({ game, initialFinalStacks, onCompleteSettlement, onCancel }: GameSettlementProps) {
